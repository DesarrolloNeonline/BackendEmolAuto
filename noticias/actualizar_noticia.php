...
function procesa()
{
		...
		document.form.action= "procesa_actualizacion_noticia.php";
	...
	<?php 
		...
		$sql_noticia = 'select titulo_noticia, subtitulo_noticia, bajada_titulo, glosa_periodistica, periodista, estado_publicacion, target
		from noticias where id_noticia = "'.$id_noticia.'"';
		$result_noticia = mysql_query($sql_noticia);
		$array_noticia = mysql_fetch_row($result_noticia);
		$titulo_noticia = $array_noticia[0];
		$subtitulo_noticia = $array_noticia[1];
		$bajada_titulo =  $array_noticia[2];
		$glosa_periodistica = $array_noticia[3];
		$periodista = $array_noticia[4];
		$estado = $array_noticia[5]; 
		$target = $array_noticia[6];
	...
	<body>	
		...
		<div id="content">
			<div id="formulario">
				<div id="pagina">
					<h2>Formulario de Actualizaci&oacute;n  de Noticia.</h2>
				</div>
			</div>
			<div id="tabla">
				<div id="row">
					<div class="span9">
						...
						<input id="id_noticia" name="id_noticia"  type="hidden" value="<?php echo $id_noticia;?>"/>	
									...
									<ul>
										<li>
											<div>
												...
												<input id="titulo_noticia" name="titulo_noticia" class="element text medium" type="text" maxlength="200" value="<?php echo $titulo_noticia;?>" placeholder="Ingrese t&iacute;tulo de noticia"/>
											</div>
										</li>
										<li>
											<div>
												 <label class="description" for="element">Subt&iacute;tulo  de noticia</label> 	
												<input id="subtitulo_noticia" name="subtitulo_noticia" class="element text medium" type="text" maxlength="200" value="<?php echo $subtitulo_noticia;?>" placeholder="Ingrese t&iacute;tulo de noticia"/>
											</div>
										</li>
										<li>
											<label style="margin-top: 20px;" class="description" >Bajada de t&iacute;tulo </label>
											<textarea name="bajada_titulo" id="bajada_titulo" class="input-xxlarge" type="text" maxlength="5000" cols="50" rows="3" value="<?php echo $bajada_titulo;?>" placeholder="Ingrese bajada de t&iacute;tulo de noticia"><?php echo $bajada_titulo;?></textarea>	
										</li>
										<li>
										...
										<li>
											...
											<textarea name="glosa" id="glosa" class="input-xxlarge" type="text" maxlength="5000" cols="50" rows="6" value="<?php echo $glosa_periodistica;?>" placeholder="Ingrese glosa period&iacute;stica de la  noticia"><?php echo $glosa_periodistica;?></textarea>	
										</li>
										<li>
							...
							?>
								...
								<div id="navmenu" style="margin-left: 30px; margin-top: 20px;">
									<ul>
										<li> 
											<input name="enviar" class="btn btn-success" type="button" id="enviar" value="Actualizar Noticia" onclick="procesa()"> 
										</li>
									</ul>
								</div>
							</div>
